...
namespace agenteconomists
{
	...
	/// <summary>
	/// Action that produces a resource to the inventory
	/// </summary>
    class AELIB_API ActionProduce : public Action
    {
    public:
		/// <summary>
		/// Constructor
		...
		/// <param name="p_resource">Resource to produce</param>
		/// <param name="p_amount">Amount to produce</param>
        ActionProduce(std::string p_name, Resource* p_resource, int p_amount) : Action(p_name), m_resource(p_resource), m_amount(p_amount) { };
